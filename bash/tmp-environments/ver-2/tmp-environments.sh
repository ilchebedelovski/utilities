...
if [ -d $SRC_PATH_1901 ]; then
        ...
        if [ -f $SQL_PATH_1901 ]; then
                ...
                $(/usr/bin/mysql -u $mysqluser -p$mysqlpass -h $mysqlhost $SQL_DB_5 -Bse "UPDATE core_config_data SET value='http://www.tmp1-mage-1901.ecomwisedev.com/' WHERE path='web/unsecure/base_url'; UPDATE core_config_data SET value='http://www.tmp1-mage-1901.ecomwisedev.com/' WHERE path='web/secure/base_url';")
                ...
                $(/usr/bin/mysql -u $mysqluser -p$mysqlpass -h $mysqlhost $SQL_DB_6 -Bse "UPDATE core_config_data SET value='http://www.tmp2-mage-1901.ecomwisedev.com/' WHERE path='web/unsecure/base_url'; UPDATE core_config_data SET value='http://www.tmp2-mage-1901.ecomwisedev.com/' WHERE path='web/secure/base_url';")
        else
